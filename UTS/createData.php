...
if(isset($_POST['submit'])) {
    ...
    $result = mysqli_query($db, "INSERT INTO uts(fakultas,animo) VALUES('$fakultas','$animo')");
    echo "
    <script>
...
<head>
    ...
    <title>UTS | Tambah Data</title>
</head>
<body>
    
    <div class="container px-4 py-4">
        <div class="header">
            <h4><strong>Tambah Data Fakultas</strong></h4>
        </div>
        <hr>
        <div class="form-edit">
            <form method="post" action="createData.php">
                ...
                <div class="row mb-3">
                    ...
                    <div class="col-sm-8 col-md-9 col-xl-10">
                        <input type="text" id="fakultas" class="form-control" name="fakultas" placeholder="Nama Fakultas" autocomplete="off" required oninvalid="this.setCustomValidity('Nama Fakultas tidak boleh Kosong')" oninput="this.setCustomValidity('')"/>
                    </div>
                </div>
                ...
                <div class="row mb-3">
                    ...
                    <div class="col-sm-8 col-md-9 col-xl-10">
                        <input type="number" class="form-control" min="0" name="animo" id="animo" placeholder="Jumlah Animo Mahasiswa" autocomplete="off" required oninvalid="this.setCustomValidity('Jumlah Animo harus angka')" oninput="this.setCustomValidity('')"/>
                    </div>
                </div>
